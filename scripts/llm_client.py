"""LiteLLM client wrapper for the sentence-pruning data runner.

The config parser builds LLMConfig objects and the pruning flow calls this module.
Provider/model/base-url choices stay explicit while LiteLLM model strings do routing.
...
ALLOWED_PROVIDERS = {"gemini", "openai", "openai-compatible", "local"}
